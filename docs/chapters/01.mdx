...
Innovation labs emerged globally as mechanisms for solving complex public and institutional challenges (OECD/Eurostat, 2018). However, single labs operating in isolation often struggle with:
...
The combination of MCF + IMM + IMM-P® + IGF + MEL produces a holistic, interoperable system (ISO, 2019).
...
graph TD
  ...
  VILF --- IN
```
This diagram is descriptive and non-normative; it shows the stated VILF principles as a non-sequential set anchored to a single conceptual core.
:::
