...
flowchart TB
  ...
  TD --- LG
```
This diagram is descriptive and non-normative; it summarizes the template domains as reference categories, without implying usage order or procedural guidance.
:::
