...
Hubs --- Labs
```
This diagram is descriptive and non-normative; it shows the three VILF tiers and their structural relationships, without implying sequence or authority beyond the chapter text.
:::
