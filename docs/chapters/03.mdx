...
flowchart TB
  ...
  PS --- IS
```
This diagram summarizes the tiered architecture and cross-cutting spines described in this chapter without implying sequence or authority beyond the text.
:::
