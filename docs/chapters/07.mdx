...
- enable governance,
- standardize quality.
This framing follows multi-perspective measurement logic while remaining specific to the VILF system (Kaplan and Norton, 1992).
...
flowchart TB
  ...
  KPI --- PL
```
This diagram is descriptive and non-normative; it maps the five KPI domains as classification lenses only, without implying scoring or evaluation flow.
:::
5 domains:
...
- MEL outputs.
Evidence expectations align with established evaluation criteria used in public-sector assessment practice (OECD, 2019).
...
- Emerging  
- Initial  
These categories support comparative interpretation alongside public performance reporting contexts (OECD, 2023).
