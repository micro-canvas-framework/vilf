...
flowchart TB
  ...
  ER --- IE
```
This diagram lists the five diagnostic pillars as a conceptual stack, without implying scoring or thresholds.
:::
...
These methods describe evidence categories, not execution steps. Execution details are defined in annexes or later phases.
